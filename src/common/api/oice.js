...
export const updateOice = (serializedOice, language) => {
  ...
  const meta = {};
  if (name.length === 0) return Promise.reject('Oice name empty!');
  meta.name = name;
...
export const importScript = ({ oiceId, language, scriptFile, progressCallback }) =>
